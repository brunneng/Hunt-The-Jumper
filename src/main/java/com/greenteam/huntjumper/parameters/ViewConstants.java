...
public final class ViewConstants
{
   ...
   public static final Color DEFAULT_GROUND_COLOR_WITH_SHADERS = /*Color.black;*/new Color(199, 199, 199);
   public static final Color DEFAULT_GROUND_COLOR_NO_SHADERS = new Color(219, 219, 219);
